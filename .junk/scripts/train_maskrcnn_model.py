...
'''
    dup from detection_control_sample_1@r730
'''
detection_control_sample_2 = '/home/sh/Github/FoodNutritionEstimation/data/mask_rcnn_detection_0400.h5'

test_list = [
    detection_control_sample_2
]
