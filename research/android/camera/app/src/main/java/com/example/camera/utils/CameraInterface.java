...
import static com.example.camera.utils.CameraParaUtil.CAMERA_FILE_PATH;
import static com.example.camera.utils.CameraParaUtil.VIDEO_FILE_PATH;
...
public class CameraInterface {
    ...
    private static String TAG="CameraInterface";
...
//        params.set("rotation", 90);//照片旋转90度
        ...
        com.example.camera.utils.CameraParaUtil.getInstance().printSupportPictureSize(params);
        com.example.camera.utils.CameraParaUtil.getInstance().printSupportPreviewSize(params);
        //设置PreviewSize和PictureSize
        Camera.Size pictureSize = com.example.camera.utils.CameraParaUtil.getInstance().getPropPictureSize(params.getSupportedPictureSizes(), viewRate, minPicWidth);
        Camera.Size previewSize = com.example.camera.utils.CameraParaUtil.getInstance().getPropPreviewSize(params.getSupportedPreviewSizes(), previewRate, minPreViewWidth);
