...
public class AllWrong extends AppCompatActivity
{
    ...
    private Handler handler = new Handler()
    {
        public void handleMessage(Message msg)
        {
            ...
            {
                case 123:
                    adapter = new listViewAdapter(AllWrong.this, list);
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_all_wrong);
        getSupportActionBar().hide();
        Intent intent = getIntent();
        loginuser = intent.getStringExtra("user");
        searchView = (SearchView) findViewById(R.id.menu_search_all_wrong);
        listView = (ListView) findViewById(R.id.food_menu_all_wrong);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener()
        {
            ...
            public boolean onQueryTextChange(String newText)
            {
                ...
                else
                {
                    ...
                    if(list.size()==0){
                        Toast.makeText(AllWrong.this,"未搜索到该菜品",Toast.LENGTH_SHORT).show();
                    }
//                    findAdapter = new listViewAdapter(FoodMenu2.this, findList);
                    findAdapter = new listViewAdapter(AllWrong.this, findList);
...
//                }
                int i =0;
                iconInformation iconInfo1 = new iconInformation();
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.beef2);
                iconInfo1.setName(foodlist[i]);
                i++;
                iconInfo1.setIcon(bitmap);
                list.add(iconInfo1);
...
//                list.add(iconInfo3);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.currybeef);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.beefpotato3);
...
//                list.add(iconInfo6);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.qctds2);
...
//                list.add(iconInfo8);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.hspg3);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.hsdp8);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.tcpg6);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.chiken8);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.hsyk6);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.hsjt1);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.dtj1);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.qchx8);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.mdcsg7);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.mdcrs2);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.cdj1);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.bdcrs1);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.khs5);
...
//                list.add(iconInfo24);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.gbrice8);
...
//                list.add(iconInfo26);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.noodle2);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.hsdy1);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.hsjy2);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.qzly);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.bzhx7);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.hszt);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.qzxhy);
...
//                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.xcxhyt);
...
//                list.add(iconInfo330);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.sswy);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.xjswy);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.cyhg);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.zyn);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.cyyn);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.szbq);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.szwd);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.wdymxr);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.szym);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.cniangao);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.zng);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.cng);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.tkos);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.symerp);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.rmcfs);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.hbd);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.jcdfg);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.jcdf);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.ymjb);
                ...
                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.xpt);
...
//                bitmap = BitmapFactory.decodeResource(AllWrong.this.getResources(), R.raw.cyszx3);
...
//        }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Log.i(TAG,"foodname"+foodname);
                final EditText et =new EditText(AllWrong.this);

                new AlertDialog.Builder(AllWrong.this).setTitle("请输入菜品重量(g)")
                        .setView(et)
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                if(et.getText().toString().equals("")){
                                    Toast.makeText(AllWrong.this,"请输入菜品重量！",Toast.LENGTH_SHORT).show();
                                }
                                else {
                                Intent intent =new Intent(AllWrong.this,FoodDetection.class);
                               // intent.putExtra("user_set_weight",et.getText().toString().trim());
                                List<String> original_nutri = mUserDataManager.today_nutri_import(daystr_import,loginuser);
                                List<Float> choosed_nutri = mUserDataManager.findFoodInfo(foodname);
                                float choosed_propertion = Float.parseFloat(et.getText().toString())/choosed_nutri.get(5);
                                String n0 = String.valueOf(Float.valueOf(choosed_nutri.get(0)*choosed_propertion)+Float.valueOf(original_nutri.get(0)));
                                String n1 = String.valueOf(Float.valueOf(choosed_nutri.get(1)*choosed_propertion)+Float.valueOf(original_nutri.get(1)));
                                String n2 = String.valueOf(Float.valueOf(choosed_nutri.get(2)*choosed_propertion)+Float.valueOf(original_nutri.get(2)));
                                String n3 = String.valueOf(Float.valueOf(choosed_nutri.get(3)*choosed_propertion)+Float.valueOf(original_nutri.get(3)));
    ...
    public void get_food_nutri(String fooodname){
