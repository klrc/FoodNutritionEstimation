...
import com.example.camera.utils.CameraInterface;

import com.example.camera.utils.CameraInterface;
import com.example.camera.utils.CameraParaUtil;
import com.example.camera.utils.CameraPreview;
import com.example.camera.utils.BitmapUtils;
import com.example.camera.utils.DialogUtil;
import com.example.camera.utils.XPermissionUtils;
...
//        Log.d(TAG, "onTakePictureSuccess picQuality: " + picQuality + ", smallBitmap.getByteCount():" + smallBitmap.getByteCount());
        ...
        finish();
        Intent intent_to_result = new Intent(SydCameraActivity.this,ResultOthers.class);
        Log.i(TAG,"loginuser："+loginuser);
        intent_to_result  .putExtra("user",loginuser);
